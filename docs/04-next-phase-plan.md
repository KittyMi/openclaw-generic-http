...
> **注意：当前联合 0.2.0 的活跃规划已移至 [09-joint-0.2.0-task-breakdown.md](./09-joint-0.2.0-task-breakdown.md)。**
> 本文档保留作为插件侧 0.2.x 早期规划的记录，第 6.1 节的进度补充仅供参考。
...
如果当前目标是继续规划双仓联合功能版本，而不是只看插件侧历史
`0.2.x` 主线，请优先查看：
